...
function sqlFilterSelect(dataToUpdate, jsToSql) {
   ...
   * query involving those keys.
   * 
   * For example, if dataToUpdate = {name: 'Billy', minEmployees: 25, maxEmployees: 40}, 
   ...
   * values would become: ['Billy', 25, 40]
   * 
